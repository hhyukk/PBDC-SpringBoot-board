...
public class PostController {
    ...
    public String write(
        ...
        if (title.length() > 20) return getWriteFormHtml("title", "제목을 최대 20자까 적어주세요.", title, content);
        ...
        if (content.length() > 100) return getWriteFormHtml("title", "내용은 최대 100자까지 입력가능합니다.", title, content);
